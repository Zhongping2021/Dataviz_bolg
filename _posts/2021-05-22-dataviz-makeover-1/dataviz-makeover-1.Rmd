...
In this article, we will show you how to plot a figure with multiple histograms by using [**ggplot2**](https://ggplot2.tidyverse.org/reference/ggplot.html) and **ggpubr** packages. 
...
this is the image of xxx: ![](img/image01.jpg)
